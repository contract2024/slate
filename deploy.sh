...
docker run --rm --name slate1 -v $(pwd)/build/zh/latest/futures-broker-api:/srv/slate/build -v $(pwd)/futures-broker-api/en/index.html.md.erb:/srv/slate/source/index.html.md.erb -v $(pwd)/futures-broker-api/en/includes:/srv/slate/source/includes futuresdocker/slate build

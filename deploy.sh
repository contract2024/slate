...
docker run --rm --name slate -v $(pwd)/build/zh/latest/API-MPC:/srv/slate/build -v $(pwd)/futures-open-api/zh/index.html.md.erb:/srv/slate/source/index.html.md.erb -v $(pwd)/futures-open-api/zh/includes:/srv/slate/source/includes futuresdocker/slate build
